...
import "./WeatherForecastFahrenheit.css";
...
export default function WeatherForecastFahrenheit(props) {
  ...
  if (forecastLoaded) {
    return (
      <div className="WeatherForecastFahrenheit">
              ...
              <div className="row" key={index}>
                ...
                <div className="col-5 forecast-temp">
                  <span className="max-temp">
                    {Math.round((dailyForecast.temp.max * 1.8 + 32))}°
                  </span>{" "}
                  ||{" "}
                  <span className="min-temp">
                    {Math.round((dailyForecast.temp.min * 1.8 +32))}°
                  </span>
                </div>
              </div>
            );
